...
4.4. Розрахунки у цьому Боті між Виконавцем і Користувачем за Послуги здійснюються за допомогою платіжного сервісу LiqPay та отримувачем коштів є "ОК САДОВО-ГОРОДНЄ ТОВАРИСТВО СТИМУЛ".
4.5. У разі неможливості або відмови скористатися послугами Виконавця, Користувач не пізніше ніж за 1 (один) календарний місяць до дати надання послуги, зазначеної в рахунку, письмово повідомляє Виконавця про це. Виконавець на підставі письмової заяви здійснює повернення сплачених Користувачем коштів протягом 1 (одного) календарного місяця з дня надання Користувачем письмової заяви із зазначенням реквізитів рахунку Користувача.
4.6. У разі неможливості чи відмови скористатися послугами Виконавця менше ніж за 1 (один) календарний місяцт до дати надання послуг, оплата, внесена Користувачем за послуги, не повертається, якщо інше не погоджено Виконавцем та Користувачем.
